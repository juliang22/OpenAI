...
public abstract class UIBuilder implements ConstantKeys {
  ...
  public void ReqBodyUIBuilder(List<PropertyDescriptor<?>> result, Map<?,?> properties, Set<String> required) {
    ...
    result.add(simpleIntegrationTemplate.localTypeProperty(builder.build())
        ...
        .isExpressionable(true)
        .label("Request Body")
        .description("Enter values to the properties below to send new or updated data to Open AI. Not all properties are " +
            "required. Make sure to remove any unnecessary autogenerated properties.")
        .instructionText("Autogenerated properties are marked 'text', 'true', '100', and '3.14' for string, boolean, integer, " +
            "and double properties, respectively. Make sure to update these autogenerated properties before making the request.")
        .refresh(RefreshPolicy.ALWAYS)
        .build());
  }
